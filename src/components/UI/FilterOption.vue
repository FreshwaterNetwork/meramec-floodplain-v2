...
function updateSlider(option, val) {
  ...
  if (
    ...
    option.field == 'al_ss_perc' ||
    option.field == 'tn_tp_del_avg_perc'
  ) {
    stringVal =
      option.field +
      ' >= ' +
